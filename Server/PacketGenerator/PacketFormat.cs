...
@"      _MakeFunc.Add((ushort)ePacket.{0}, MakePacket<{0}>);
        _handler.Add((ushort)ePacket.{0}, PacketHandler.{0}Handler);
";
        // {0} 패킷 이름 / 번호 목록
        // {1} 패킷 목록
...
{{
    ...
    public ushort Protocol {{ get {{ return (ushort)ePacket.{0}; }} }}
    ...
    {{
        ...
        count += sizeof(ushort);
        Array.Copy(BitConverter.GetBytes((ushort)ePacket.{0}), 0, segment.Array, segment.Offset + count, sizeof(ushort));
